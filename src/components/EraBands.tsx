...
export function EraBandHeader({ year, prevYear }: EraHeaderProps) {
  ...
  return (
    <div className="flex items-center gap-2 px-3 py-1 rounded-md border border-om-border bg-om-era-band text-xs font-medium my-1">
      <span className="text-om-gold font-serif">{current.name}</span>
